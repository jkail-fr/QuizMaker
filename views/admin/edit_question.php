        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
                        <input type="checkbox" id="<?php echo $donnees['ID_Cat']; ?>" name="newchoix[]" value="<?php echo $donnees['ID_Cat']; ?>" <?php
            ...
            <tr>
                ...
                <td>
                    ...
                    while ($donnees = $reponse->fetch()) {
                    ?>
                        <input type="checkbox" id="<?php echo $donnees['ID_Niv']; ?>" name="newniveau[]" value="<?php echo $donnees['ID_Niv']; ?>" <?php
